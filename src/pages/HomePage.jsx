    ...
    <div className="text-center">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
        ...
        >
          ...
          <h2 className="text-2xl font-bold mb-3">Linh kiện PC</h2>
        ...
        >
          ...
          <h2 className="text-2xl font-bold mb-3">Xây dựng PC</h2>
          <p className="text-gray-600">
        ...
        >
          <div className="text-6xl mb-4">💬</div>
          <h2 className="text-2xl font-bold mb-3">Diễn đàn</h2>
          <p className="text-gray-600">
